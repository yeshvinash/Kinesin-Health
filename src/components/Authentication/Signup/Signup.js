      ...
      content: (
        <>
          ...
          <Form>
            ...
            <div className="d-flex align-items-center mt-4 pt-2 click-here-links-wrap">
          ...
          {!verificationCodeSent ? (
            ...
            <>
              ...
              <Form>
                ...
                <div className="mt-4 pt-2 d-flex align-items-center click-here-links-wrap">
                  <span className="text-manatee fw-500 me-3">
                    Time Left to Verify
                  </span>
            ...
            <>
              ...
              <Form className="mt-0">
                <Link to="/login" className="custom_btn w-100 login_btn mb-0">
                  Home
                </Link>
              </Form>
            </>
      ...
      <section className="authentication-wrapper signup-form-wrapper">
        <div className="d-flex align-items-center justify-content-between authentication-header">
          ...
          <div className="d-flex align-items-center">
            <span className="text-manatee fw-500 me-3 d-none d-lg-block">
