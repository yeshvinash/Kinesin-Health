        ...
        <div className="page-title-wrap d-flex align-items-center justify-content-between">
          ...
          <div>
            <Button className="custom_btn danger_btn">
              <Image src={deleteIcon} className="me-2" /> <span> Delete Dependants</span>
            </Button>
          </div>
        </div>
          ...
          <Form className="profile-form">
            <div className="profile-form-wrap">
              ...
              <div className="personal-info-grid-box">
                <div className="personal-info-grid-item1">
                  <div>
                ...
                <div className="personal-info-grid-item2">
                  <div>
            ...
            <div className="profile-form-wrap">
              ...
              <div>
                <div className="mb-4 pb-3 d-flex address-wrap justify-content-between align-items-center ">
